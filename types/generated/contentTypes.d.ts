...
export interface ApiDashboardDashboard extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'Data Dashboard Page';
...
export interface ApiMainNavigationMainNavigation
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TopLevelLink: Schema.Attribute.Component<
...
export interface ApiOurTeamOurTeam extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Education: Schema.Attribute.Component<'shared.team-member', true>;
    Leadership: Schema.Attribute.Component<'shared.team-member', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
